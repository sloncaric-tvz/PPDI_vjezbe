...
//provjeri je li odabrana država
if ($selectedCode != '') {
...
<section class="container country-summary">
    ...
    <div class="summary-content">
        ...
        <p>
            ...
            and uses <?= ucfirst($restCountryInfo['currencies'][(string)$country->currency]['name']); ?> 
            (<?= $restCountryInfo['currencies'][(string)$country->currency]['symbol']; ?>) as its currency.
        </p>
        ...
        <article class="data-card">
            ...
            <dl class="detail-list">
                ...
                <div>
                    ...
                    <dd>
                        <?php
                            echo $restCountryInfo['name']['official'] . '<hr>';
                            foreach ($restCountryInfo['name']['nativeName'] as $key => $value) {
                                echo '(' . $value['official'] . ')<hr>';
                            }
                        ?>
                    </dd>
                </div>
                <div>
                    <dt>Currency</dt>
                    <dd><?= ucfirst($restCountryInfo['currencies'][(string)$country->currency]['name']); ?> 
            (<?= $restCountryInfo['currencies'][(string)$country->currency]['symbol']; ?>)</dd>
                </div>
                <div>
                    <dt>Map link</dt>
