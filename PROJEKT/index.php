...
<section class="hero-section">
    <div class="container hero-layout">
        <div class="hero-copy">
            ...
            <p class="hero-text">
                A PHP project template for displaying local XML data, local JSON travel tips,
                and external REST API data about countries and currency exchange rates.
            </p>
            <div class="hero-actions">
                <a class="button button-primary" href="<?= e(url_for('country.php')); ?>">View country template</a>
...
<section class="container section-stack">
    <div class="section-heading">
        ...
        <p>Each page is prepared with placeholder areas where you can add PHP logic.</p>
    </div>
