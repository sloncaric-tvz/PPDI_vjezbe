...
<section class="container section-stack">
    <div class="concept-grid">
        <article class="concept-card">
            <h2>XML</h2>
            <p>
                The file <code>countries2.xml</code> stores structured country records with predictable fields:
        ...
        <article class="concept-card">
            <h2>XML Schema</h2>
            <p>
                The file <code>countries2.xsd</code> defines the allowed XML structure and validates that required
        ...
        <article class="concept-card">
            <h2>JSON</h2>
            <p>
                The file <code>travel_tips2.json</code> stores flexible travel data such as daily budget,
