...
$isXmlValid = validate_countries_xml($xmlPath, $xsdPath);
...
<section class="container section-stack">
    <form class="filter-form" method="get" action="countries.php">
        ...
        <a class="button button-ghost" href="<?= e(url_for('countries.php')); ?>">Reset filters</a>
    </form>
</section>
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($countries as $country): ?>
                        <?php $url = e(url_for('country.php?code=' . $country->attributes()->code)); ?>
                        <tr>
                            <td><?= $country->name; ?></td>
